...
public class CompletableFutureDemo {
    public static void main(String[] args) {
        ...
        final List<Integer> taskList = Arrays.asList(2, 1, 3, 5, 4, 6, 7, 8, 9, 10);
        try {
            ...
            for (int i = 0; i < taskList.size(); i++) {
                ...
                CompletableFuture<String> future = CompletableFuture.supplyAsync(() -> calc(taskList.get(j)), exs)
                        ...
                        //如需获取任务完成先后顺序，此处代码即可
//                        .whenComplete((v, e) -> {
//                            System.out.println("任务" + v + "完成!result=" + v + "，异常 e=" + e + "," + DateUtil.date());
//                            list2.add(v);
//                        })
                        ;
            ...
            for (CompletableFuture<String> stringCompletableFuture : futureList) {
...
//            System.out.println("任务完成先后顺序，结果list2=" + list2 + "；任务提交顺序，结果list=" + list + ",耗时=" + (System.currentTimeMillis() - start));
    ...
    public static Integer calc(Integer i) {
        try {
            ...
            System.out.println("task线程：" + Thread.currentThread().getName() + "任务i=" + i + ",完成！+" + DateUtil.date());
