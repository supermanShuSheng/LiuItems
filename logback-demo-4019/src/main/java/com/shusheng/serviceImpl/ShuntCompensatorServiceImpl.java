...
import com.shusheng.cime.ShuntCompensatorEntity;
 ...
 */
@Service
public class ShuntCompensatorServiceImpl extends CimeParseAbstract<ShuntCompensatorEntity> {

    /**
     * 标签信息
     */
    private static final String TAG_NODE = "ShuntCompensator";
     ...
     */
    @Override
    public List<ShuntCompensatorEntity> getCimeResourceList(Dict dict) {
