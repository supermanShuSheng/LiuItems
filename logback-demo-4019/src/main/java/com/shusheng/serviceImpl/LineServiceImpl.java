...
import com.shusheng.cime.LineEntity;
 ...
 */
@Service
public class LineServiceImpl extends CimeParseAbstract<LineEntity> {

    /**
     * 标签信息
     */
    private static final String TAG_NODE = "Line";
     ...
     */
    @Override
    public List<LineEntity> getCimeResourceList(Dict dict) {
