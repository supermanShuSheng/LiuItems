...
import com.shusheng.cime.EndDeviceEntity;
 ...
 */
@Service
public class EndDeviceServiceImpl extends CimeParseAbstract<EndDeviceEntity> {

    /**
     * 标签信息
     */
    private static final String TAG_NODE = "EndDevice";
     ...
     */
    @Override
    public List<EndDeviceEntity> getCimeResourceList(Dict dict) {
