...
import com.shusheng.cime.AnalogEntity;
 ...
 */
@Service
public class AnalogServiceImpl extends CimeParseAbstract<AnalogEntity> {

    /**
     * 标签信息
     */
    private static final String TAG_NODE = "Analog";
     ...
     */
    @Override
    public List<AnalogEntity> getCimeResourceList(Dict dict) {
