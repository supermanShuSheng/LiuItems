...
import com.shusheng.cime.BreakerEntity;
 ...
 */
@Service
public class BreakerServiceImpl extends CimeParseAbstract<BreakerEntity> {

    /**
     * 标签信息
     */
    private static final String TAG_NODE = "Breaker";
     ...
     */
    @Override
    public List<BreakerEntity> getCimeResourceList(Dict dict) {
