...
import com.shusheng.cime.PowerTransformerEntity;
 ...
 */
@Service
public class PowerTransformerServiceImpl extends CimeParseAbstract<PowerTransformerEntity> {

    /**
     * 标签信息
     */
    private static final String TAG_NODE = "PowerTransformer";
     ...
     */
    @Override
    public List<PowerTransformerEntity> getCimeResourceList(Dict dict) {
