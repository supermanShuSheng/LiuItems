...
import com.shusheng.cime.BayEntity;
 ...
 */
@Service
public class BayServiceImpl extends CimeParseAbstract<BayEntity> {

    /**
     * 标签信息
     */
    private static final String TAG_NODE = "Bay";
     ...
     */
    @Override
    public List<BayEntity> getCimeResourceList(Dict dict) {
