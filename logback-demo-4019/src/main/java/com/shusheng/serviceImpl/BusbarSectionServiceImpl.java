...
import com.shusheng.cime.BusbarSectionEntity;
 ...
 */
@Service
public class BusbarSectionServiceImpl extends CimeParseAbstract<BusbarSectionEntity> {

    /**
     * 标签信息
     */
    private static final String TAG_NODE = "BusbarSection";
     ...
     */
    @Override
    public List<BusbarSectionEntity> getCimeResourceList(Dict dict) {
